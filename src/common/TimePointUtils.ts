...
export class TimePointUtils {
  ...
  static getTimeScale(items: ITacoTimePoint[], totalWidth: number, padding: number = 20) {
   ...
   * @param timepoints
   */
  static selectTimePoint(...timepoints: ITacoTimePoint[]) {
   ...
   * @param timepoints
   */
  static selectTimePointFromHash(timepoints: ITacoTimePoint[]) {
