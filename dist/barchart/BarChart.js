...
class BarChart {
    ...
    constructor(parent, options) {
        ...
        this.widthBar = AppConstants.TIMELINE_BAR_WIDTH;
        // Width and Height for the bar chart between time points
        this.widthBarChart = AppConstants.TIMELINE_BAR_WIDTH;
        this.heightBarChart = 100;
        this.barScaling = d3.scale.linear()
            .domain([0, 1])
    ...
    updateItems(items) {
        ...
        $bars.enter().append('div')
            ...
            const ids = pair.map((d) => d.item.desc.id);
